...
import com.shooping.ecommerce.service.repository.DetallePedidoRepository;
import com.shooping.ecommerce.service.repository.PedidoRepository;
...
public class PedidoService {
  ...
  private final ItemRepository pRepository;
  ...
  public GenericResponse guardarPedido(GenerarPedidoDTO dto) {
    ...
    for (DetallePedido dp : dto.getDetallePedidos()) {
      ...
      this.pRepository.descontarStock(dp.getCantidad(), dp.getItem().getId());
    }
  ...
  private void restablecerStock(final int pedidoId) {
    ...
    for (DetallePedido dp : detalles) {
      pRepository.aumentarStock(dp.getCantidad(), dp.getItem().getId());
    }
  }
